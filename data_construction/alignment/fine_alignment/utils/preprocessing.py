...
# Set the parallel_data cleaning method
...
def fetch_subsets_a4k(episode, en_subtitle, zh_subtitle, season_id, episode_id, zh_split=False):
    """
    ...
    old_en_subset = [clean_sentence_brackets(item) for item in en_subtitle[(season_id, episode_id)]]
    old_zh_subset = [clean_sentence_brackets(item) for item in zh_subtitle[(season_id, episode_id)]]
    en_subset = []
    zh_subset = []
